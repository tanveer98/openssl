 ...
 * Actual list of Cname and NID is in `crypto/objects/obj_mac.num` file
 *
...
// it seems that NID is defined in crypto/objects/obj_mac.num where  `chacha20_poly1305` is cname and 1018 is NID
// and SN and LN are defined in `crypto/objects/objects.txt` for the given Cname chacha20_poly1305
